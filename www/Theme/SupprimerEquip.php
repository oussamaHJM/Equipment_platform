      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Supprimer les équipements : </h3>
          <div class="row mt">
            <div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table id="myTable"  class="order-table table" class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th class="numeric">Date d'achat</th>
                                ...
                                while($data=$select->fetch()){
                                    ?>
                                    <tr>
                                            <td><?php echo $data['ID_EQUIPMENT']; ?></td>
                                            ...
                                            <td> <a class="btn btn-theme03" href="suprimer.php?id=<?php echo ''.$data['ID_EQUIPMENT']; ?>">Supprimer </a> </td>
                                    </tr>
                                    <?php
