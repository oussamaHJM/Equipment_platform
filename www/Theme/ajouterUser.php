      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Ajouter Un Utilisateur</h3>
            <?php
              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                    <div class="sghir">
                      ...
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Saisir Les Information D' Un Utilisateur</h4>
                      <form class="form-horizontal style-form" action="../../controller/gestionFomulaire.php?operation=ajouterUser" method="post"  >
                          ...
                          <div class='form-group' >
                              ...
                              <div class='col-sm-10'>
                                  <select type='text' name='entite' class='form-control'>
